...
void generateData(BuildContext context) {
  ...
  users = [
    User(
        ...
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img1.jpg")),
    User(
        id: 2,
        nickname: "Mauri38",
        password: "mauri",
        genrer: Genrer.MALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img2.jpg")),
    User(
        id: 3,
        nickname: "Steven2019",
        password: "steven",
        genrer: Genrer.MALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img3.jpg")),
    User(
        id: 4,
        nickname: "Leopoldo500",
        password: "leopoldo",
        genrer: Genrer.MALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img4.jpg")),
    User(
        id: 5,
        nickname: "Julia38",
        password: "julia",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img6.jpg")),
    User(
        id: 6,
        nickname: "KatyPerez",
        password: "katy",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img7.jpg")),
    User(
        id: 7,
        nickname: "EnrryLirico",
        password: "enrry",
        genrer: Genrer.MALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img8.jpg")),
    User(
        id: 8,
        nickname: "RosaFuentes",
        password: "rosa",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img9.jpg")),
    User(
        id: 9,
        nickname: "MarlonMartinez",
        password: "marlon",
        genrer: Genrer.MALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img10.jpg")),
    User(
        id: 10,
        nickname: "EsperanzaJoya",
        password: "esperanza",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img11.jpg")),
    User(
        id: 10,
        nickname: "Gumercinda",
        password: "gumercinda",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img12.jpg")),
    User(
        id: 11,
        nickname: "EnriquetaValle",
        password: "enriqueta",
        genrer: Genrer.MALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img13.jpg")),
    User(
        id: 12,
        nickname: "LuzAlf",
        password: "luz",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img14.jpg")),
    User(
        id: 13,
        nickname: "SorayaCastaneda",
        password: "soraya",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img15.jpg")),
    User(
        id: 14,
        nickname: "SuyinHu",
        password: "suyin",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img16.jpg")),
    User(
        id: 15,
        nickname: "EstelaMartinez",
        password: "estela",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img17.jpg")),
    User(
        id: 16,
        nickname: "LuisaMagañ",
        password: "luisa",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img18.jpg")),
    User(
        id: 17,
        nickname: "Yakinawa",
        password: "yakinawa",
        genrer: Genrer.FEMALE,
        photo: ase.AssetFile(assetBundle, "assets/images/usuarios/img19.jpg")),
    User(
        id: 18,
  ...
  recipes = <Recipe>[
    ...
    Recipe(
        ...
        user: users[7],
        photo: ase.AssetFile(assetBundle,
